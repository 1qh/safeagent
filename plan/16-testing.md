...
- System architecture: [03 — Architecture](./03-architecture.md)
- Foundation and shared conventions: [04 — Foundation](./04-foundation.md)
- Conversation behavior: [05 — Conversation](./05-conversation.md)
- Agents: [06 — Agents](./06-agents.md)
- Memory design and responsibilities: [07 — Memory](./07-memory.md)
- Document processing: [08 — Documents](./08-documents.md)
- Retrieval and RAG behavior: [09 — Retrieval](./09-retrieval.md)
- Guardrails and policy enforcement: [10 — Guardrails](./10-guardrails.md)
- Transport and event semantics: [11 — Transport](./11-transport.md)
- Server behavior and auth enforcement details: [12 — Server](./12-server.md)
- Terminal interface expectations: [13 — TUI](./13-tui.md)
