...
- 24 docs in `plan`: `Cross-References` sections were removed as redundant navigation blocks after centralizing navigation in agent-kernel/start-here/domain-playbooks.
